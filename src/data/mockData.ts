...
export const cities = [
  { slug: 'london', name: 'London', costLevel: 'High' as const, description: 'The capital city with world-class universities and endless opportunities.', transport: 'Oyster card, Tube, buses, Overground', neighborhoods: ['Shoreditch', 'Camden', 'Greenwich', 'Stratford', 'Wembley'], avgRentStudent: '£180–300/week', avgRentProfessional: '£1,200–2,000/month', transportMonthlyCost: '£140–180', indianCommunityAreas: ['Wembley', 'Southall', 'Tooting', 'East Ham', 'Hounslow'] },
  { slug: 'manchester', name: 'Manchester', costLevel: 'Medium' as const, description: 'A vibrant northern hub with strong tech and creative industries.', transport: 'Metrolink trams, buses', neighborhoods: ['Fallowfield', 'Didsbury', 'Northern Quarter', 'Salford'], avgRentStudent: '£120–180/week', avgRentProfessional: '£700–1,100/month', transportMonthlyCost: '£70–90', indianCommunityAreas: ['Rusholme (Curry Mile)', 'Longsight', 'Cheetham Hill', 'Levenshulme'] },
  { slug: 'birmingham', name: 'Birmingham', costLevel: 'Medium' as const, description: "England's second city with a diverse community and growing economy.", transport: 'West Midlands Metro, buses', neighborhoods: ['Selly Oak', 'Edgbaston', 'Jewellery Quarter'], avgRentStudent: '£110–170/week', avgRentProfessional: '£650–1,000/month', transportMonthlyCost: '£65–80', indianCommunityAreas: ['Sparkhill', 'Sparkbrook', 'Handsworth', 'Smethwick', 'Soho Road'] },
  { slug: 'edinburgh', name: 'Edinburgh', costLevel: 'Medium-High' as const, description: "Scotland's capital with stunning architecture and top universities.", transport: 'Lothian buses, trams', neighborhoods: ['Marchmont', 'Newington', 'Leith'], avgRentStudent: '£140–220/week', avgRentProfessional: '£800–1,300/month', transportMonthlyCost: '£55–70', indianCommunityAreas: ['Leith', 'Newington', 'Gorgie'] },
  { slug: 'glasgow', name: 'Glasgow', costLevel: 'Medium-Low' as const, description: 'Friendly city with great nightlife and affordable living.', transport: 'Subway, buses, trains', neighborhoods: ['West End', 'Merchant City', 'Finnieston'], avgRentStudent: '£100–160/week', avgRentProfessional: '£600–950/month', transportMonthlyCost: '£50–65', indianCommunityAreas: ['Pollokshields', 'Govanhill', 'Woodlands'] },
  { slug: 'leeds', name: 'Leeds', costLevel: 'Medium' as const, description: 'Fast-growing northern city with a thriving student scene and financial sector.', transport: 'Buses, trains, cycling routes', neighborhoods: ['Headingley', 'Hyde Park', 'City Centre', 'Chapel Allerton'], avgRentStudent: '£110–170/week', avgRentProfessional: '£650–1,000/month', transportMonthlyCost: '£60–75', indianCommunityAreas: ['Hyde Park', 'Harehills', 'Chapeltown', 'Roundhay'] },
  { slug: 'bristol', name: 'Bristol', costLevel: 'Medium-High' as const, description: 'Creative, green city with a strong tech sector and vibrant arts scene.', transport: 'First buses, ferries, cycling', neighborhoods: ['Clifton', 'Stokes Croft', 'Harbourside', 'Redland'], avgRentStudent: '£130–200/week', avgRentProfessional: '£800–1,200/month', transportMonthlyCost: '£60–75', indianCommunityAreas: ['Easton', 'St Pauls', 'Redfield'] },
  { slug: 'nottingham', name: 'Nottingham', costLevel: 'Medium-Low' as const, description: 'Affordable university city with great nightlife and two major universities.', transport: 'Trams (NET), buses', neighborhoods: ['Lenton', 'Beeston', 'Hockley', 'West Bridgford'], avgRentStudent: '£100–160/week', avgRentProfessional: '£600–900/month', transportMonthlyCost: '£55–65', indianCommunityAreas: ['Hyson Green', 'Sneinton', 'Forest Fields'] },
  { slug: 'liverpool', name: 'Liverpool', costLevel: 'Medium-Low' as const, description: 'Cultural capital with affordable living, rich history, and a welcoming community.', transport: 'Merseyrail, buses', neighborhoods: ['Baltic Triangle', 'Smithdown', 'Georgian Quarter', 'Allerton'], avgRentStudent: '£100–150/week', avgRentProfessional: '£550–850/month', transportMonthlyCost: '£55–70', indianCommunityAreas: ['Toxteth', 'Smithdown Road', 'Lodge Lane'] },
  { slug: 'coventry', name: 'Coventry', costLevel: 'Low' as const, description: 'UK City of Culture with two universities and excellent value for money.', transport: 'Buses, National Rail', neighborhoods: ['Earlsdon', 'Canley', 'City Centre', 'Tile Hill'], avgRentStudent: '£90–140/week', avgRentProfessional: '£500–800/month', transportMonthlyCost: '£50–60', indianCommunityAreas: ['Foleshill', 'Hillfields', 'Stoke'] },
];
